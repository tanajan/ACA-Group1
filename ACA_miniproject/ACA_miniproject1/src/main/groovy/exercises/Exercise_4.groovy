...
print("Data inserted\n")
//fetching only written by Tom Brady

println "Result from fetching name Tom Brady"
db.getCollection("lab2").find(new BasicDBObject().append('from.name', 'Tom Brady')).each{ println it }
